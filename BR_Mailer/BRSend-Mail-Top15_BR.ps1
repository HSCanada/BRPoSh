...
$body=get-content ($path +"J050_TOP15_FSC_BR\Email.Msg.Body\ETU_MSG_FSC_Top_15.htm") | out-string
...
$list=import-csv ($path + "J050_TOP15_FSC_BR\"+"J050_Mailing_List.csv")



$startTime = Get-date
$startLog = 'Top15 BR -' +$startTime
